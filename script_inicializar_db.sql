...
CREATE SEQUENCE persona_identificador_seq
START WITH 6
INCREMENT BY 1;
ALTER TABLE persona ALTER identificador SET DEFAULT NEXTVAL('persona_identificador_seq');
...
CREATE SEQUENCE alumno_identificador_seq
START WITH 6
INCREMENT BY 1;
ALTER TABLE alumno ALTER identificador SET DEFAULT NEXTVAL('alumno_identificador_seq');
